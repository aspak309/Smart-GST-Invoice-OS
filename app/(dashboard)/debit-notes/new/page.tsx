...
export default function NewDebitNotePage() {
  ...
  const calculations = useMemo(() => {
    ...
    items.forEach((item) => {
      ...
      const itemTaxable = quantity * rate;
  ...
  const handleSave = (status: DebitNoteStatus) => {
    ...
    try {
      ...
      console.error("Failed to save debit note:", error);
      ...
      <div className="mx-auto flex min-h-[70vh] max-w-xl items-center justify-center px-4">
        <div className="w-full rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-sm sm:p-12">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-500">
            Your debit note has been successfully saved
            and is now available in the Debit Notes section.
          </p>
      ...
      <div className="mb-7 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-500">
            Create a debit note for purchase adjustments,
            additional charges or supplier corrections.
          </p>
        </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white">
            <div className="border-b border-slate-200 p-5 sm:p-6">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Enter the basic debit note information.
              </p>
            </div>
            ...
            <div className="grid gap-5 p-5 sm:grid-cols-2 sm:p-6">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Example: Additional charges, quantity correction..."
                  rows={3}
          ...
          <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
            <div className="flex items-center justify-between border-b border-slate-200 p-5 sm:p-6">
              <div>
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Add products or services for this debit note.
                </p>
              </div>
          ...
          <div className="sticky top-6 overflow-hidden rounded-2xl border border-slate-200 bg-white">
            ...
            <div className="border-t border-slate-100 bg-slate-50 p-5">
              <p className="text-xs leading-5 text-slate-500">
                Review all supplier and item information
                carefully before issuing the debit note.
              </p>
            </div>
          </div>
        </aside>
